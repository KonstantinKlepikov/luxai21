...
class GenConstruct:
    ...
    def Probability(self) -> namedtuple:
        ...
        if self.__Probability is None:
            workers_per = [method for method in dir(WorkerPerformance) if method.startswith('mission_')]
            carts_per = [method for method in dir(CartPerformance) if method.startswith('mission_')]
            citytiles_per = [method for method in dir(CityPerformance) if method.startswith('mission_')]
